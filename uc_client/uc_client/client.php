...
function uc_user_register($username, $realname, $password, $email, $schoolname, $questionid = '', $answer = '', $regip = '') {
	return call_user_func(UC_API_FUNC, 'user', 'register', array('username'=>$username, 'realname'=>$realname, 'password'=>$password, 'email'=>$email, 'schoolname'=>$schoolname, 'questionid'=>$questionid, 'answer'=>$answer, 'regip' => $regip));
}
...
function uc_user_edit($username, $oldpw, $newpw, $email, $schoolname, $ignoreoldpw = 0, $questionid = '', $answer = '') {
	return call_user_func(UC_API_FUNC, 'user', 'edit', array('username'=>$username, 'oldpw'=>$oldpw, 'newpw'=>$newpw, 'email'=>$email, 'schoolname'=>$schoolname, 'ignoreoldpw'=>$ignoreoldpw, 'questionid'=>$questionid, 'answer'=>$answer));
}
...
function uc_get_username_by_email($email) {
	return call_user_func(UC_API_FUNC, 'user', 'get_username_by_email', array('email'=>$email));
}
