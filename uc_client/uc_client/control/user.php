...
class usercontrol extends base {
	...
	function onregister() {
		...
		$uid = $_ENV['user']->add_user($username, $realname, $password, $email, $schoolname, 0, $questionid, $answer, $regip);
		return $uid;
	}
	...
	function onedit() {
		...
		$status = $_ENV['user']->edit_user($username, $oldpw, $newpw, $email, $schoolname, $ignoreoldpw, $questionid, $answer);
	...
	function onlogin() {
		...
		return array($status, $user['username'], $user['realname'], $password, $user['email'], $user['schoolname'], $merge);
	}
	...
	function onmerge() {
		...
		$uid = $_ENV['user']->add_user($newusername, $realname, $password, $email, $schoolname, $uid);
